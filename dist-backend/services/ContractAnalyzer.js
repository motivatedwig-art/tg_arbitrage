...
export class ContractAnalyzer {
     ...
     */
    detectBlockchainFromAddress(address) {
     ...
     */
    detectEVMChain(address, context) {
     ...
     */
    async verifyContractOnChain(address, blockchain) {
     ...
     */
    getBlockchainFromContract(address, context) {
...
//# sourceMappingURL=ContractAnalyzer.js.map