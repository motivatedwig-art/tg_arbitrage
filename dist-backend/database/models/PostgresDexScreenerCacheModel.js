export class PostgresDexScreenerCacheModel {
    constructor(db) {
        this.CACHE_TTL_DAYS = 7; // Cache expires after 7 days
        this.db = db;
    }
    async createTable() {
        const sql = `
...
//# sourceMappingURL=PostgresDexScreenerCacheModel.js.map