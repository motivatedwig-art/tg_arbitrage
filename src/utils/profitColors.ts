 ...
 */
export function getProfitColor(profitPercentage: number): ProfitColors {
 ...
 */
export function getProfitRowStyles(profitPercentage: number) {
 ...
 */
export function getProfitBadgeColors(profitPercentage: number): {
  bg: string;
  text: string;
} {
  if (profitPercentage >= 3) {
